...
})(window,document,'script','crema-jssdk','//widgets.cre.ma/shehj.com/init.js');
</script>
```
...
<script>(function(i,s,o,g,r,a,m){if(s.getElementById(g)){return};a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.id=g;a.async=1;a.src=r;m.parentNode.insertBefore(a,m)})(window,document,'script','crema-jssdk','//widgets.cre.ma/shehj.com/mobile/init.js');</script>
```
...
})(window,document,'script','crema-jssdk','//widgets.cre.ma/shehj.com/mobile/init.js');
</script>
```
